...
const userInfo = "CREATE TABLE IF NOT EXISTS playerData (PLAYERNAME string, PLATFORM text, PRIMARY KEY(PLAYERNAME, PLATFORM))";

const overallStats = "CREATE TABLE IF NOT EXISTS overall (PLAYERNAME string, PLATFORM string, 'Top 3' string, 'Top 3s' string, 'Top 5s' string, 'Top 6s' string, 'Top 12s' string, 'Top 25s' string, 'Score' string, 'Matches Played' string, 'Wins' string, 'Win%' string, 'Kills' string, 'K/d' string, 'Kills Per Min' string, 'Time Played' string, 'Avg Survival Time' string, PRIMARY KEY(PLAYERNAME, PLATFORM))"; 
...
const overallStats_squad = "CREATE TABLE IF NOT EXISTS overall_squad (PLAYERNAME text, PLATFORM text,'TRN Rating' string, 'Score' string, 'Wins' string, 'Top 3' string, 'Top 5' string, 'Top 6' string, 'Top 10' string, 'Top 12' string, 'Top 25' string, 'K/d' string, 'Win %' string, 'Matches' string, 'Kills' string, 'Time Played' string, 'Kills Per Min' string, 'Kills Per Match' string, 'Avg Match Time' string, 'Score per Match' string, 'Score per Minute' string, PRIMARY KEY(PLAYERNAME, PLATFORM))"; 
